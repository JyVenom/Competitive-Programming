...
public class GuessTheAnimal7 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ArrayList<GuessTheAnimal7> characteristicsList = new ArrayList<>();
        boolean has;
        ...
        for (int i = 0; i < numAnimals; i++){
            for (int j = 2; j <= (1 + Integer.parseInt(data[i][1])); j++){
                has = false;
                for (GuessTheAnimal7 guessTheAnimal : characteristicsList) {
                ...
                if (!has){
                    GuessTheAnimal7 temp = new GuessTheAnimal7(1, data[i][j]);
        ...
        for (String[] strings : temp) {
            characteristicsList.add(new GuessTheAnimal7(Integer.parseInt(strings[0]), strings[1]));
        }
//
...
//        }
        ...
        for (int i = 0; i < data.length - 1; i++) {
            ...
            ArrayList<GuessTheAnimal7> characteristicsListTemp = new ArrayList<>(characteristicsList);
            GuessTheAnimal7 guessTheAnimal6 = characteristicsList.get(i);
//            characteristicsList.remove(i);
            ...
            for (int a = 0; a < characteristicsList.size(); a++) {
                GuessTheAnimal7 guessTheAnimal = characteristicsList.get(a);
...
//                                haveToBreak = true;
                ...
                for (int b = 0; b < numAnimals; b++){
                    ...
                    for (int c = 2; c <= (1 + Integer.parseInt(finalList[b][1])); c++){
                        has2 = false;
                        for (GuessTheAnimal7 guessTheAnimal2 : characteristicsList) {
                        ...
                        if (!has2){
                            GuessTheAnimal7 temp3 = new GuessTheAnimal7(1, finalList[b][c]);
                            characteristicsList.add(temp3);
                        }
                        if (b + 1 != finalList.length) {
    ...
    private GuessTheAnimal7(int o, String c){
        occurrences = o;
        characteristic = c;
    }
