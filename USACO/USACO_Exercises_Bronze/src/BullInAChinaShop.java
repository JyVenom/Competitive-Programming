...
public class BullInAChinaShop {
    public static void main(String[] args) throws IOException {
        ...
        int size = Integer.parseInt(info.substring(0, info.indexOf(' ')));
        int numPieces = Integer.parseInt(info.substring(info.indexOf(' ') + 1));
        boolean[][] orig = read(sc, size);
        boolean[][][] pieces = new boolean[numPieces][size][size];
    ...
    public static boolean[][] read(Scanner sc, int size){
