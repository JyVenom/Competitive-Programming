...
public class GuessTheAnimal3 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ArrayList<GuessTheAnimal3> characteristicsList = new ArrayList<>();
        boolean has;
        ...
        for (int i = 0; i < numAnimals; i++){
            for (int j = 2; j <= (1 + Integer.parseInt(data[i][1])); j++){
                has = false;
                for (GuessTheAnimal3 guessTheAnimal : characteristicsList) {
                ...
                if (!has){
                    GuessTheAnimal3 temp = new GuessTheAnimal3(1, data[i][j]);
...
//        }
        ...
        for (int i = 0; i < data.length - 1; i++) {
            ...
            System.arraycopy(data, i, finalList, 0, data.length - i);
            int count = 0;
            ...
            for (int a = 0; a < characteristicsList.size(); a++) {
                GuessTheAnimal3 guessTheAnimal = characteristicsList.get(a);
...
//                }
    ...
    private GuessTheAnimal3(int o, String c){
        occurrences = o;
        characteristic = c;
    }
