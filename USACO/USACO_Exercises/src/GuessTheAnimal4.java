...
public class GuessTheAnimal4 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ArrayList<GuessTheAnimal4> characteristicsList = new ArrayList<>();
        boolean has;
        ...
        for (int i = 0; i < numAnimals; i++){
            for (int j = 2; j <= (1 + Integer.parseInt(data[i][1])); j++){
                has = false;
                for (GuessTheAnimal4 guessTheAnimal : characteristicsList) {
                ...
                if (!has){
                    GuessTheAnimal4 temp = new GuessTheAnimal4(1, data[i][j]);
        ...
        for (String[] strings : temp) {
            characteristicsList.add(new GuessTheAnimal4(Integer.parseInt(strings[0]), strings[1]));
        }
//
...
//        }
        ...
        GuessTheAnimal4 characteristicsList1 = characteristicsList.get(0);
        characteristicsList.set(0, characteristicsList.get(5));
        characteristicsList.set(5, characteristicsList1);
...
//                }
    ...
    private GuessTheAnimal4(int o, String c){
        occurrences = o;
        characteristic = c;
    }
