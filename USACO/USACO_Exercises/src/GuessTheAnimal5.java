...
public class GuessTheAnimal5 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ArrayList<GuessTheAnimal5> characteristicsList = new ArrayList<>();
        boolean has;
        ...
        for (int i = 0; i < numAnimals; i++){
            for (int j = 2; j <= (1 + Integer.parseInt(data[i][1])); j++){
                has = false;
                for (GuessTheAnimal5 guessTheAnimal : characteristicsList) {
                ...
                if (!has){
                    GuessTheAnimal5 temp = new GuessTheAnimal5(1, data[i][j]);
        ...
        for (String[] strings : temp) {
            characteristicsList.add(new GuessTheAnimal5(Integer.parseInt(strings[0]), strings[1]));
        }
//
...
//        }
        ...
        GuessTheAnimal5 characteristicsList1 = characteristicsList.get(0);
        characteristicsList.set(0, characteristicsList.get(7));
        characteristicsList.set(7, characteristicsList1);

        int largest = characteristicsList.get(0).occurrences;
        int last = 0;
        for (int i = 0; i < characteristicsList.size(); i++){
            if (characteristicsList.get(i).occurrences == largest){
                last = i;
            }
            else {
                break;
...
//                }
    ...
    private GuessTheAnimal5(int o, String c){
        occurrences = o;
        characteristic = c;
    }
