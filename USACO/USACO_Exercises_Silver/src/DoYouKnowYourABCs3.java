...
public class DoYouKnowYourABCs3 {
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
            ...
            if (n == 7) {
                ...
                // Missing a and a+c or b+c or a+b+c
                {
                    int b = arr[0];
                ...
                //missing b and a+c, b+c, or a+b+c
                {
                    int a = arr[0];
                ...
                // Missing other
                {
                    ...
                    {//if c is less than a+b or a+b is missing
                        int c = arr[2];
