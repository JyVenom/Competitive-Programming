...
public class ComfortableCows15 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int half = (n + 1) / 2;
        sz = n + half;
        map2 = new boolean[sz][sz];
        boolean[][] map = new boolean[n + half][n + half + 2];
        int prev = 0;
        for (int i = 0; i < n; i++) {
            int col = ir.nextInt() + half;
            int row = ir.nextInt() + half;
