...
//                            count++; //Jerry
                            notVisited[integer / n][integer % n] = true;
                        }
                        ...
                        while (combined.size() > 0) {
                            ...
                            size = twoRegion(combined.get(0) / n, combined.get(0) % n, notVisited, size, combined);
...
//        }
    ...
    private static int twoRegion(int i, int j, boolean[][] notVisited, int size, ArrayList<Integer> coordinates) {
//        if (step == 3) {
//            count++; //Jerry
//        }
        notVisited[i][j] = false;
        size++;
        int index = binarySearchRemove(coordinates, 0, coordinates.size() - 1, i * n + j);
        if (index != -1) {
