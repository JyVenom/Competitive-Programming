...
public class ComfortableCows17 {
    private static final int[] dirRow = new int[]{-1, 0, 1, 0};
    private static final int[] dirCol = new int[]{0, 1, 0, -1};
    private static final boolean[][] map2 = new boolean[1501][1501];
    private static final boolean[][] visited = new boolean[1501][1501];
    ...
    public static void main(String[] args) throws IOException {
        ...
        int n = ir.nextInt();
        boolean[][] map = new boolean[1501][1501];
        int prev = 0;
        ArrayDeque<int[]> queue = new ArrayDeque<>();
        for (int i = 0; i < n; i++) {
            int col = ir.nextInt() + 500;
            int row = ir.nextInt() + 500;
