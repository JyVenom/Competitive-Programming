...
public class MilkVisits10 {
    ...
    private static void dfs(HashMap<Integer, HashMap<Integer, ArrayList<int[]>>> friends, ArrayList<ArrayList<Integer>> edges, LinkedList<Integer> path, boolean[] visited, int[][] last, int[][] times, int[] type, int[] ans, int cur, int depth) {
        visited[cur] = true;
        path.add(cur);
