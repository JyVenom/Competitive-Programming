...
//
//        }
        long ans = helper(new int[]{f[0], f[1], b[0], b[1]}, fPath, bPath, endF, endB, 0, 0, 0, Long.MAX_VALUE);
...
//        pw.println(min[endF[0]][endF[1]][endB[0]][endB[1]]);
    ...
    private static long helper (int[] cur, int[] fPath, int[] bPath, int[] endF, int[] endB, int remF, int remB, long curVal, long ans) {
        ...
        if (remF < fPath.length) {
            ...
            ans = helper(next, fPath, bPath, endF, endB, remF + 1, remB, newVal, ans);
        }
        if (remB < bPath.length) {
            ...
            ans = helper(next, fPath, bPath, endF, endB, remF, remB + 1, newVal, ans);
        }
        if (remF < fPath.length && remB < bPath.length) {
            ...
            ans = helper(next, fPath, bPath, endF, endB, remF + 1, remB + 1, newVal, ans);
        }
