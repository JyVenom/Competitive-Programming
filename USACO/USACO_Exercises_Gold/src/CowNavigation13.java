...
//        visited = new boolean[n][n][n][n][4];
    ...
    private static int BFS1(boolean[][][][] visited, boolean[][] data, int N) {
        ...
        queue.offer(new state(0, 0, 0, 0, 0, 0));

        while (!queue.isEmpty()) {
            state cur = queue.removeFirst();
            visited[cur.ax][cur.ay][cur.bx][cur.by] = true;
            ...
            if (!visited[cur.ax][cur.ay][cur.bx][cur.by] && !queue.contains(leftTurn)) {
            ...
            if (!visited[cur.ax][cur.ay][cur.bx][cur.by] && !queue.contains(rightTurn)) {
            ...
            if (cur.dir == 0) {
                ...
                if (!visited[cur.ax][ay][bx][cur.by] && !queue.contains(next)) {
                    queue.offer(next);
                }
                ...
                if (!visited[ax][cur.ay][cur.bx][by] && !queue.contains(next)) {
                    queue.offer(next);
                }
            } else if (cur.dir == 2) {
                int ay = cur.ay;
    ...
    private static int BFS2(boolean[][][][] visited, boolean[][] data, int N) {
        LinkedList<state> queue = new LinkedList<>();
        queue.offer(new state(0, 0, 0, 0, 1, 0));
