...
public class BessiesDream3 {
    public static void main(String[] args) throws IOException {
        ...
        DijkstrasShortestPathAdjacencyListWithDHeapWithIntegers d = new DijkstrasShortestPathAdjacencyListWithDHeapWithIntegers(max, m);
        d.setGraph2(map);
        int N = n - 1;
        int M = m - 1;
        for (int i = 0; i < n; i++) {
        ...
        ArrayList<Integer> temp = d.reconstructPath(0, n * m - 1);
    ...
    public static class DijkstrasShortestPathAdjacencyListWithDHeapWithIntegers {
         ...
         */
        public DijkstrasShortestPathAdjacencyListWithDHeapWithIntegers(int n, int m) {
            this.n = n;
            this.m = m;
            createEmptyGraph();
        }
