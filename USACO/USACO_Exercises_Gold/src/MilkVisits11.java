...
public class MilkVisits11 {
    ...
    private static void dfs(HashMap<Integer, HashMap<Integer, ArrayList<int[]>>> friends, ArrayList<ArrayList<Integer>> edges, HashMap<Integer, Integer> path, boolean[] visited, int[][] last, int[][] times, int[] type, int[] ans, int cur, int depth) {
        visited[cur] = true;
        path.put(depth, cur);
