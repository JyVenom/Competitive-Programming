...
public class comehome {
    public static void main(String[] args) throws IOException {
        ...
        DijkstrasShortestPathAdjacencyListWithDHeapWithIntegers dij = new DijkstrasShortestPathAdjacencyListWithDHeapWithIntegers(52);
        for (int i = 0; i < p; i++) {
            String[] line = br.readLine().split(" ");
            int a = line[0].charAt(0) - 65;
            int b = line[1].charAt(0) - 65;
        ...
        pw.println((char) (min + 65) + " " + dist[min]);
        pw.close();
    }
    ...
    static class DijkstrasShortestPathAdjacencyListWithDHeapWithIntegers {
        ...
        private List<List<comehome.DijkstrasShortestPathAdjacencyListWithDHeapWithIntegers.Edge>> graph;
        ...
        public void addEdge(int from, int to, int cost) {
            edgeCount++;
            graph.get(from).add(new comehome.DijkstrasShortestPathAdjacencyListWithDHeapWithIntegers.Edge(to, cost));
            graph.get(to).add(new comehome.DijkstrasShortestPathAdjacencyListWithDHeapWithIntegers.Edge(from, cost));
        }
        ...
        public int[] dijkstra(int start) {
            ...
            comehome.DijkstrasShortestPathAdjacencyListWithDHeapWithIntegers.MinIndexedDHeap<Integer> ipq = new comehome.DijkstrasShortestPathAdjacencyListWithDHeapWithIntegers.MinIndexedDHeap<>(degree, n);
            ipq.insert(start, 0);
            ...
            while (!ipq.isEmpty()) {
                ...
                for (comehome.DijkstrasShortestPathAdjacencyListWithDHeapWithIntegers.Edge edge : graph.get(nodeId)) {
