...
public class ratios2 {
    ...
    private static boolean isMultiple (int[] cur, int[] goal) {
        if (cur[0] == 100 && cur[1] == 40 && cur[2] == 4) {
            System.out.println();
        }
        if (((cur[0] == 0 && goal[0] == 0) || cur[0] % goal[0] == 0) && ((cur[1] == 0 && goal[1] == 0) || cur[1] % goal[1] == 0) && ((cur[2] == 0 && goal[2] == 0) || cur[2] % goal[2] == 0)) {
            return ((cur[0] == 0 && goal[0] == 0) || (cur[1] == 0 && goal[1] == 0) || (cur[0] / goal[0] == cur[1] / goal[1])) && ((cur[1] == 0 && goal[1] == 0) || (cur[2] == 0 && goal[2] == 0) || (cur[1] / goal[1] == cur[2] / goal[2]));
        }
        return false;
    }
}
