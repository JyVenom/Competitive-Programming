...
public class msquare4 {
    public static void main(String[] args) throws IOException {
        ...
        int end = Integer.parseInt("" + target[0] + target[1] + target[2] + target[3] + target[4] + target[5] + target[6] + target[7]);

        DijkstrasShortestPathAdjacencyListWithDHeapWithIntegers dij = new DijkstrasShortestPathAdjacencyListWithDHeapWithIntegers(87654322);
        for (int a = 1; a <= 8; a++) {
            for (int b = 1; b <= 8; b++) {
                if (b == a) {
                    continue;
                            ...
                            for (int f = 1; f <= 8; f++) {
                                ...
                                for (int g = 1; g <= 8; g++) {
                                    ...
                                    for (int h = 1; h <= 8; h++) {
                                        ...
                                        int from = Integer.parseInt(temp);
        ...
        ArrayList<Integer> path = dij.reconstructPath(12345678, end);
    ...
    private static int A (String c) {
        int[] cur = new int[8];
        for (int i = 0; i < 8; i++) {
            cur[i] = Character.getNumericValue(c.charAt(i));
        }
        for (int i = 0; i < 4; i++) {
            int temp = cur[i];
            cur[i] = cur[7 - i];
        ...
        return Integer.parseInt("" + cur[0] + cur[1] + cur[2] + cur[3] + cur[4] + cur[5] + cur[6] + cur[7]);
    }

    @SuppressWarnings("SuspiciousSystemArraycopy")
    private static int B (String c) {
        int[] cur = new int[8];
        for (int i = 0; i < 8; i++) {
            cur[i] = Character.getNumericValue(c.charAt(i));
        }
