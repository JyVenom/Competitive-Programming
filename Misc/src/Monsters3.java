...
//        }
    ...
    private static boolean BFS(boolean[][] lab, int[][] dist, int row, int col, int N, int M) {
        LinkedList<int[]> queue = new LinkedList<>();
        queue.offer(new int[]{row, col, 0});
        boolean[][] visited = new boolean[dist.length][dist[0].length];
...
//            int sz = path.size();
//            if (!visited[cur[0] - 1][cur[1]] && lab[cur[0] - 1][cur[1]]) {
//                path.add('U');
//                if (DFS(lab, visited, dist, cur[0] - 1, cur[1], cost + 1, N, M)) {
//                    return true;
//                }
//                path.remove(sz);
//            }
//            if (!visited[cur[0]][cur[1] + 1] && lab[cur[0]][cur[1] + 1]) {
//                path.add('R');
//                if (DFS(lab, visited, dist, cur[0], cur[1] + 1, cost + 1, N, M)) {
//                    return true;
//                }
//                path.remove(sz);
//            }
