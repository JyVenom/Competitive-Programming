...
public class ForestQueries4 {
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < q; i++) {
            sb.append(forest[queries[i][2]][queries[i][3]] - forest[queries[i][0] - 1][queries[i][3]] - forest[queries[i][2]][queries[i][1] - 1] + forest[queries[i][0] - 1][queries[i][1] - 1]).append("\n");
        }
